<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 ps bg-white" id="sidenav-main">
	...
	<div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
		<ul class="navbar-nav">
			<li class="nav-item">
				<a class="nav-link active text-dark bg-gradient-warning" href="{{ asset('material-dashboard/pages/dashboard.html') }}">
			...
			<li class="nav-item">
				<a class="nav-link text-dark " href="{{ asset('material-dashboard/pages/tables.html') }}">
					<div class="text-dark text-center me-2 d-flex align-items-center justify-content-center">
			...
			<li class="nav-item">
				<a class="nav-link text-dark " href="{{ asset('material-dashboard/pages/profile.html') }}">
					<div class="text-dark text-center me-2 d-flex align-items-center justify-content-center">
			...
			<li class="nav-item">
				<a class="nav-link text-dark " href="{{ asset('material-dashboard/pages/sign-in.html') }}">
					<div class="text-dark text-center me-2 d-flex align-items-center justify-content-center">
